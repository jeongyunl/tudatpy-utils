...
{
	const ParsedUtcIso p = TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02T03:04:05");
...
{
	const ParsedUtcIso p = TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02 03:04:05");
	EXPECT_EQ(p.year, 2020);
	EXPECT_EQ(p.month, 1);
	EXPECT_EQ(p.day, 2);
	EXPECT_EQ(p.hour, 3);
...
{
	const ParsedUtcIso p = TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02T03:04:05.1");
	EXPECT_EQ(p.nanos, NANOSECONDS_PER_SECOND / 10);
}

TEST(ParseIso8601Utc, FractionalSecondsTruncatesBeyondNanos)
{
	const ParsedUtcIso p =
		TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02T03:04:05.123456789123");
...
{
	const ParsedUtcIso p =
		TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02T03:04:05+02:30");
...
{
	const ParsedUtcIso p =
		TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02T03:04:05-05:00");
...
{
	const ParsedUtcIso p = TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2016-12-31T23:59:60");
...
TEST(FormatIso8601Utc, CanonicalZulu)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true), "2020-01-02T03:04:05");
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, false), "2020-01-02 03:04:05");
}
...
TEST(FormatIso8601Utc, TrimsFractionalTrailingZeros)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true, 2), "2020-01-02T03:04:05.12");
}
...
TEST(FormatIso8601Utc, PreservesTimezoneOffset)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p), "2020-01-02 03:04:05-05:30");
}
...
TEST(FormatIso8601Utc, FormatsLeapSecond)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true), "2016-12-31T23:59:60.25");
}

TEST(FormatIso8601Utc, ParseFormatRoundTripCanonicalizesSeparator)
{
	const ParsedUtcIso parsed =
		TimeConverterBase::instance().utc_iso_to_parsed_utc_iso("2020-01-02 03:04:05.123400000+02:30");
	EXPECT_EQ(
		TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(parsed, true, 4),
		"2020-01-02T03:04:05.1234+02:30"
	);
}
...
TEST(FormatIso8601Utc, LimitsFractionalSecondPlaces)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true, 3), "2020-01-02T03:04:05.123");
	EXPECT_EQ(
		TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true, 6),
		"2020-01-02T03:04:05.123457"
	);
	EXPECT_EQ(
		TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true, 9),
...
TEST(FormatIso8601Utc, OmitsFractionalWhenZeroPlaces)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, true, 0), "2020-01-02T03:04:05");
}
...
TEST(FormatIso8601Utc, CombineSpaceSeparatorAndFractional)
{
	...
	EXPECT_EQ(TimeConverterBase::instance().parsed_utc_iso_to_utc_iso(p, false, 3), "2020-01-02 03:04:05.5");
}
