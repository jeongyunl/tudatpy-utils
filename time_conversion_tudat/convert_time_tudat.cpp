...
std::string posix_to_utc_iso(const double posix_time)
{
	try
	{
		const double utc_tudat_time = posix_time - POSIX_EPOCH_MINUS_UTC_TUDAT_EPOCH;
...
double posix_to_posix(const double posix_time)
{
	return posix_time;
}

double posix_to_utc_tudat(const double posix_time)
{
...
double utc_tudat_to_posix(const double utc_tudat_time)
{
	return utc_tudat_time + POSIX_EPOCH_MINUS_UTC_TUDAT_EPOCH;
}

double utc_tudat_to_utc_tudat(const double utc_tudat_time)
{
...
double tai_tudat_to_tai_tudat(const double tai_tudat_time)
{
...
{
	return tai_tudat_time + TT_EPOCH_MINUS_TAI_EPOCH;
}
...
{
	return tt_tudat_time - TT_EPOCH_MINUS_TAI_EPOCH;
}

double tt_tudat_to_tt_tudat(const double tt_tudat_time)
{
...
double tdb_tudat_to_tdb_tudat(const double tdb_tudat_time)
{
